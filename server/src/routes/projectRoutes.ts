...
router.get('/:id/owner-impact', authenticate, authorizeRoles('ADMIN', 'MANAGER'), projectController.getProjectOwnerImpact);
router.put('/:id/assign-owner', authenticate, authorizeRoles('ADMIN', 'MANAGER'), projectController.assignProjectOwner);
