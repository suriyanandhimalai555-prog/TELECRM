...
export default function Notes() {
  ...
  const filteredNotes = Array.isArray(notes) ? notes.filter(note => 
    ...
    (note.lead_name && note.lead_name.toLowerCase().includes(searchTerm.toLowerCase()))
  ) : [];
  ...
  return (
    <div className="h-full flex flex-col space-y-8 relative">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 flex-1 overflow-hidden">
        ...
        >
          <div className="bg-white p-8 rounded-[2.5rem] shadow-sm border border-gray-100 anime-aura-glow relative overflow-hidden group">
        ...
        <div className="lg:col-span-2 flex flex-col space-y-6 overflow-hidden">
          <motion.div 
            ...
            className="bg-white p-6 rounded-[2rem] shadow-sm border border-gray-100 flex items-center group anime-aura-glow"
          >
            ...
            <AnimatePresence>
              {filteredNotes.map((note, index) => (
                <motion.div 
                  ...
                  className="bg-white p-8 rounded-[2.5rem] shadow-sm border border-gray-100 group hover:border-aura-red/20 transition-all anime-observation cursor-default relative overflow-hidden"
                >
